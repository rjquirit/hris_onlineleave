...
return [
    ...
    */
    ...
    |
    */
    'layout' => env('TYRO_LOGIN_LAYOUT', 'centered'), // Using centered layout for clean API integration
    ...
    */
    'branding' => [
        ...
        'app_name' => env('TYRO_LOGIN_APP_NAME', 'HRIS Online Leave'),
    ...
    */
    'redirects' => [
        'after_login' => env('TYRO_LOGIN_REDIRECT_AFTER_LOGIN', '/personnel'), // Redirect to personnel page after login
        'after_logout' => env('TYRO_LOGIN_REDIRECT_AFTER_LOGOUT', '/login'),
        'after_register' => env('TYRO_LOGIN_REDIRECT_AFTER_REGISTER', '/personnel'),
    ...
    */
    'features' => [
        ...
        // Disabled for API token-based auth (tokens don't expire like sessions)
        'remember_me' => env('TYRO_LOGIN_REMEMBER_ME', false),
    ...
    */
    'otp' => [
        ...
        // Disabled initially for API integration (can be implemented in Phase 2)
    ...
    */
    'lockout' => [
        ...
        // Disabled for API integration (can be implemented with Laravel rate limiting)
